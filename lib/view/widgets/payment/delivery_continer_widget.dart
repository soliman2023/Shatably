...
/*  final controller = Get.find<PayMentController>();
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        buildRadioContiner(
          address: "Egypt,Shopria Ahmed Helmy ST",
          name: "Staply ",
          phone: "51-887-9932",
          title: "Staply ",
          value: 1,
        ...
        buildRadioContiner(
          address: 'Cairo',//controller.address.value,
          name: 'mina',//authController.displayUserName.value,
          phone:'0120256863',//controller.phoneNumber.value,
          title: "Delivery",
          value: 2,
